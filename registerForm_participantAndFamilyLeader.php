                        ...
                        if (count >= 12) {
                            ...
                            for (let i = 1; i <= count; i++) {
                                ...
                                section.innerHTML = `
                                    ...
                                    <input type="tel" id="family_phone_${i}" name="family[${i}][phone]" pattern="\\([0-9]{3}\\) [0-9]{3}-[0-9]{4}" required placeholder="Ex. (555) 555-5555">
                                    ...
                                    <input type="tel" id="family_emergency_contact_phone_${i}" name="family[${i}][emergency_contact_phone]" pattern="\\([0-9]{3}\\) [0-9]{3}-[0-9]{4}" required placeholder="Enter emergency contact phone number. Ex. (555) 555-5555">
